...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        # Labels
        self.score_label = Label(text="Score: 0", bg=THEME_COLOR, pady=20, font=("arial", 10, "bold"), fg="white")
        self.score_label.grid(row=0, column=1, sticky="N")
        # Canvas
        self.canvas = Canvas(width=300, height=250, bg="white", highlightthickness=0)
        self.question_text = self.canvas.create_text(150, 125, text="question", width=290, font=("Arial", 15, "italic"),
                                                     fill=THEME_COLOR)
